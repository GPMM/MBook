      ...
      System.Reflection.Assembly.GetExecutingAssembly().GetName().CodeBase))))+ CGenDef.ImageDir + "\\";
        ...
        private void pictureBox_Click(object sender, EventArgs e)
        {
            ...
            if (ctr != null)
            {
                ...
                richTextBox1.Clear();
                richTextBox1.Text = "Title: " + ctr.Image.Tag.ToString();
                CBook oBook = CConfig.Instance.GetBook(ctr.Image.Tag.ToString());
                richTextBox1.AppendText("\n");
                richTextBox1.AppendText("ISBN: " + oBook.ISBN);
                richTextBox1.AppendText("\n");
                richTextBox1.AppendText("Author: " + oBook.Author);
                richTextBox1.AppendText("\n");
                richTextBox1.AppendText("Publisher: " + oBook.Editora);

                richTextBox2.Clear();
                richTextBox2.AppendText("Description: " + oBook.Description);
