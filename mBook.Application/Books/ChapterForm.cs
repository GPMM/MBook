...
namespace MBook.Books
{
    public partial class ChapterForm : Form
    {
        ...
        public ChapterForm(Book oBook, Form Fmain):this()
        {
            m_oBook = oBook;
            m_fMain = Fmain;
            ...
            splitContainer1.Panel2.BackgroundImage = new Bitmap(GenDef.BooksDir + m_oBook.NameId + "\\cover.png");
        ...
        private Button CreateDynamicButton(string sName, string sText, int sTag, Point pLocation)
        {
            ...
            dynamicButton.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
        ...
        private void dynamicButton_click(object sender, EventArgs e)
        {
            ...
            if (ctr != null)
            {
                ...
                circularButton1.Tag = ctr.Tag;
                circularButton1.BringToFront();
                circularButton1.Location = new Point(ctr.Location.X + ctr.Width - 45, ctr.Location.Y + ctr.Height - 43);
